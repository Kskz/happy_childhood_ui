...
class AppColors {
  ...
  static const Color gray = Color(0xFFF0F1F3);
  static const Color whitish = Color(0xFFfbf9fa);
  static const Color white = Color(0xFFFFFFFF);
  static const Color green = Color(0xFFb2ebc2);
  ...
  static const Color litePurple = Color(0xFFdbd5ef);
  static const Color bluish = Color(0xFFd1e0fd);
  static const Color purple= Color.fromRGBO(160, 168, 215, 1);
